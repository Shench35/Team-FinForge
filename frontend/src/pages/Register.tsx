    ...
    >
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <p className="text-[10px] text-on-surface-variant/70 leading-relaxed text-center px-4">
          By clicking "Create Account", you agree to our <Link to="/terms" className="font-bold hover:underline">Terms of Service</Link> and <Link to="/privacy" className="font-bold hover:underline">Privacy Policy</Link>.
        </p>
        ...
        <div className="pt-6 border-t border-[#F1F5F9] flex justify-center items-center gap-8">
          <div className="flex items-center gap-1.5 opacity-40">
            ...
            <p className="text-[9px] font-bold uppercase tracking-[0.1em]">AES-256 ENCRYPTION</p>
          </div>
          <div className="flex items-center gap-1.5 opacity-40">
            <ShieldCheck className="w-3.5 h-3.5" />
            <p className="text-[9px] font-bold uppercase tracking-[0.1em]">ISO 27001 CERTIFIED</p>
          </div>
        </div>
      </form>
    </AuthLayout>
